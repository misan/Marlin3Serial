...
#include "WString.h"
  ...
  #define MYSERIAL3 P3Serial
#endif

#define SERIAL_PROTOCOL(x) (MYSERIAL.print(x),MYSERIAL3.print(x))
#define SERIAL_PROTOCOL_F(x,y) (MYSERIAL.print(x,y),MYSERIAL3.print(x,y))
