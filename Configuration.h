...
#define X_MAX_POS 2024
#define X_MIN_POS 0
#define Y_MAX_POS 1188
#define Y_MIN_POS 0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {3200/15/5.08,3200/15/5.08,3200/15/5.08,760*1.1}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {1800, 1800, 1800, 25}    // (mm/sec)
